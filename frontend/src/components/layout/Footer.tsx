...
export function Footer() {
  return (
    <footer className="border-t-3 border-black bg-slate-950 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="#" title="Official Website" aria-label="Official Website" className="w-8 h-8 rounded-md bg-slate-900 border-2 border-black flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:bg-slate-800 transition-colors shadow-[2px_2px_0px_#000]"><Globe className="w-4 h-4" /></a>
              <a href="#" title="Community Chat" aria-label="Community Chat" className="w-8 h-8 rounded-md bg-slate-900 border-2 border-black flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:bg-slate-800 transition-colors shadow-[2px_2px_0px_#000]"><MessageCircle className="w-4 h-4" /></a>
              <a href="#" title="Photo Gallery" aria-label="Photo Gallery" className="w-8 h-8 rounded-md bg-slate-900 border-2 border-black flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:bg-slate-800 transition-colors shadow-[2px_2px_0px_#000]"><Camera className="w-4 h-4" /></a>
            </div>
          </div>
